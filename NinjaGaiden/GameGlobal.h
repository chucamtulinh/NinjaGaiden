...
private:
	static HINSTANCE mHInstance; //hInstance cua windows hien tai
	static HWND mHwnd; // hwnd hien tai
	static LPD3DXSPRITE mSpriteHandler; //spriteHanlder hien tai
	static int mWidth, mHeight; //size cua so
	static LPDIRECT3DDEVICE9 mDevice; //device directX hien tai
};
