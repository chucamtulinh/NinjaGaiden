...
#define BRICK_TEXTURE_PATH L"rect.png"
#define MARIO_TEXTURE_PATH L"mario.png"


#define BACKGROUND_COLOR D3DCOLOR_XRGB(202,229,232)
...
int Run()
{
	...
	DWORD tickPerFrame = 1000 / MAX_FRAME_RATE;// do thi sin 500, chay quanh map thi 100
