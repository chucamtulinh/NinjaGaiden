...
void MGraphic::DrawTexture(LPDIRECT3DTEXTURE9 texture, D3DXVECTOR2 position, D3DCOLOR color) {
...
void MGraphic::DrawTexture(LPDIRECT3DTEXTURE9 texture, RECT source, D3DXVECTOR2 position, D3DCOLOR color) {
	this->d3dxSprite->Draw(
		texture,
		&source,
		NULL,
